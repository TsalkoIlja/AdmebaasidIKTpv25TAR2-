...
--
-- Host: 127.0.0.1
-- Loomise aeg: Veebr 26, 2026 kell 03:29 PL
...
CREATE TABLE `kaup` (
  ...
  `liigi_kood` int(11) DEFAULT NULL,
  `hind` decimal(10,2) NOT NULL CHECK (`hind` > 0)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- --------------------------------------------------------

--
-- Tabeli struktuur tabelile `liik`
--
...
--
-- Tabeli struktuur tabelile `muuk`
--

CREATE TABLE `muuk` (
  `muugi_kood` int(11) NOT NULL,
  `kauba_kood` int(11) DEFAULT NULL,
  `ostja_kood` int(11) DEFAULT NULL,
  `arv` int(11) NOT NULL CHECK (`arv` > 0),
  `kuupaev` date DEFAULT curdate()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Indeksid tabelile `muuk`
--
ALTER TABLE `muuk`
  ADD PRIMARY KEY (`muugi_kood`),
  ADD KEY `fk_Muuk_Kaup` (`kauba_kood`),
  ADD KEY `fk_Muuk_Customer` (`ostja_kood`);
...
--
ALTER TABLE `kaup`
  MODIFY `kauba_kood` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT tabelile `liik`
--
ALTER TABLE `liik`
  MODIFY `liigi_kood` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT tabelile `muuk`
--
ALTER TABLE `muuk`
  MODIFY `muugi_kood` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `kaup`
  ADD CONSTRAINT `fk_Kaup_Liik` FOREIGN KEY (`liigi_kood`) REFERENCES `liik` (`liigi_kood`) ON DELETE SET NULL ON UPDATE CASCADE;

--
-- Piirangud tabelile `muuk`
--
ALTER TABLE `muuk`
  ADD CONSTRAINT `fk_Muuk_Customer` FOREIGN KEY (`ostja_kood`) REFERENCES `customer` (`idCustomer`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_Muuk_Kaup` FOREIGN KEY (`kauba_kood`) REFERENCES `kaup` (`kauba_kood`) ON DELETE SET NULL ON UPDATE CASCADE;
